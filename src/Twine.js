...
if (config.browser.isBadSafari) {
    config.textPrimitives.upperLetter = "[A-Z\u00c0-\u00de]";
    config.textPrimitives.lowerLetter = "[a-z\u00df-\u00ff_0-9\\-]";
    config.textPrimitives.anyLetter = "[A-Za-z\u00c0-\u00de\u00df-\u00ff_0-9\\-]";
}
else {
...
TiddlyWiki.prototype.getTags = function () {
    ...
    results.sort(function (a, b) {
        if (a[0].toLowerCase() == b[0].toLowerCase()) return (0); else return (a[0].toLowerCase() < b[0].toLowerCase()) ? -1 : +1;
    });
    return results;
}
...
TiddlyWiki.prototype.getTiddlers = function (field) {
    ...
    if (field)
        results.sort(function (a, b) {
            if (a[field] == b[field]) return (0); else return (a[field] < b[field]) ? -1 : +1;
        });
    return results;
}
